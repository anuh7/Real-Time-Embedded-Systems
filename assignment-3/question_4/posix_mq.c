...
//forward slash is file system separator
...
//attribtutes of message queue, man number of mssgs and max mssg size
...
void *receiver(void *arg)
{
  ...
  //message queue descriptor type used to represnt an open mq.
  mqd_t mymq;
